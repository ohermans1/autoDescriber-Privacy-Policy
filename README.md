...
## autoDescriber Shopify 应用隐私政策

在autoDescriber，我们非常重视您的隐私。本隐私政策描述了您在使用我们的autoDescriber Shopify 应用（以下简称“应用”）时，我们如何收集、使用和分享您的信息。
...
## autoDescriber Shopify 應用隱私政策

在 autoDescriber，我們非常重視您的隱私。本隱私政策描述了您在使用我們的 autoDescriber Shopify 應用（以下簡稱「應用」）時，我們如何收集、使用和分享您的信息。
...
## Zásady ochrany osobních údajů pro Shopify aplikaci autoDescriber

V autoDescriberu bere ochranu vašich osobních údajů vážně. Tato Zásady ochrany osobních údajů popisují, jak sbíráme, používáme a sdílíme informace o vás, když používáte naši Shopify aplikaci autoDescriber (dále jen "Aplikace").
...
## Fortrolighedspolitik for autoDescriber Shopify-app

Hos autoDescriber tager vi dit privatliv alvorligt. Denne fortrolighedspolitik beskriver, hvordan vi indsamler, bruger og deler oplysninger om dig, når du bruger vores autoDescriber Shopify-app (herefter kaldet "appen").
...
## Privacybeleid voor autoDescriber Shopify App

Bij autoDescriber nemen we jouw privacy zeer serieus. Dit Privacybeleid beschrijft hoe we informatie over jou verzamelen, gebruiken en delen wanneer je onze autoDescriber Shopify App (hierna "de App") gebruikt.
...
## Tietosuojaseloste autoDescriber Shopify -sovellukselle

Me autoDescriberissa suhtaudumme yksityisyyteesi erittäin vakavasti. Tämä tietosuojaseloste kuvaa, miten keräämme, käytämme ja jaamme tietoa sinusta, kun käytät autoDescriber Shopify -sovellustamme (jäljempänä "Sovellus").
...
## Politique de confidentialité pour l'application Shopify autoDescriber

Chez autoDescriber, nous prenons votre vie privée très au sérieux. Cette politique de confidentialité décrit comment nous collectons, utilisons et partageons des informations vous concernant lorsque vous utilisez notre application Shopify autoDescriber (ci-après "l'Application").
...
## Datenschutzrichtlinie für die autoDescriber Shopify App

Bei autoDescriber nehmen wir Ihren Datenschutz sehr ernst. Diese Datenschutzrichtlinie beschreibt, wie wir Informationen über Sie sammeln, verwenden und teilen, wenn Sie unsere autoDescriber Shopify App (im Folgenden "App") verwenden.
...
## Informativa sulla privacy per l'app Shopify autoDescriber

Da autoDescriber, prendiamo molto sul serio la tua privacy. Questa Informativa sulla privacy descrive come raccogliamo, utilizziamo e condividiamo le informazioni su di te quando utilizzi la nostra app Shopify autoDescriber (di seguito "l'App").
...
## autoDescriber Shopifyアプリのプライバシーポリシー

autoDescriberでは、お客様のプライバシーを非常に重要視しています。このプライバシーポリシーでは、当社のautoDescriber Shopifyアプリ（以下、「アプリ」）を使用する際にお客様から収集、利用、共有する情報について説明しています。
...
## autoDescriber Shopify 앱 개인정보 처리방침

autoDescriber에서는 귀하의 개인정보를 심각하게 취급합니다. 본 개인정보 처리방침은 당사의 autoDescriber Shopify 앱(이하 "앱")을 사용할 때 귀하에 관한 정보를 어떻게 수집, 사용 및 공유하는지에 대해 설명합니다.
...
## Personvernserklæring for autoDescriber Shopify App

Hos autoDescriber tar vi ditt personvern svært alvorlig. Denne personvernserklæringen beskriver hvordan vi samler inn, bruker og deler informasjon om deg når du bruker vår autoDescriber Shopify App (heretter "Appen").
...
## Polityka prywatności dla aplikacji Shopify autoDescriber

W autoDescriber traktujemy Twoją prywatność bardzo poważnie. Niniejsza Polityka Prywatności opisuje, jak zbieramy, używamy i udostępniamy informacje o Tobie, gdy korzystasz z naszej aplikacji Shopify autoDescriber (dalej "Aplikacja").
...
## Política de Privacidade para o aplicativo autoDescriber Shopify

Na autoDescriber, levamos sua privacidade muito a sério. Esta Política de Privacidade descreve como coletamos, usamos e compartilhamos informações sobre você quando você usa nosso aplicativo autoDescriber Shopify (doravante "Aplicativo").
...
## Política de Privacidade para a aplicação autoDescriber Shopify

Na autoDescriber, levamos a sua privacidade muito a sério. Esta Política de Privacidade descreve como recolhemos, usamos e partilhamos informações sobre si quando utiliza a nossa aplicação autoDescriber Shopify (doravante "Aplicação").
...
## Política de privacidad para la aplicación autoDescriber de Shopify

En autoDescriber, tomamos tu privacidad muy en serio. Esta Política de privacidad describe cómo recopilamos, usamos y compartimos información sobre ti cuando utilizas nuestra aplicación autoDescriber de Shopify (en adelante, "la aplicación").
...
## Integritetspolicy för autoDescriber Shopify-app

På autoDescriber tar vi din integritet på största allvar. Denna Integritetspolicy beskriver hur vi samlar in, använder och delar information om dig när du använder vår autoDescriber Shopify-app (nedan "appen").
...
# Thai <a name="thai"></a>
## นโยบายความเป็นส่วนตัวสำหรับแอป autoDescriber บน Shopify

ที่ autoDescriber เราใส่ใจเรื่องความเป็นส่วนตัวของคุณอย่างมาก นโยบายความเป็นส่วนตัวนี้อธิบายถึงวิธีการเราเก็บรวบรวม ใช้ และแบ่งปันข้อมูลเกี่ยวกับคุณเมื่อคุณใช้แอป autoDescriber บน Shopify ของเรา (ต่อไปนี้ว่า "แอป").
...
## autoDescriber Shopify Uygulaması İçin Gizlilik Politikası

autoDescriber'da gizliliğiniz bizim için çok önemlidir. Bu Gizlilik Politikası, autoDescriber Shopify Uygulamamızı (bundan sonra "Uygulama" olarak anılacaktır) kullanırken sizi ilgilendiren bilgileri nasıl topladığımızı, kullanıp paylaştığımızı açıklar.
